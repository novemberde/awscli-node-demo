...
const main = async () => {
    try {
        ...
        signal.success("RouteTable is created");
        ...
        signal.success("Route is created");        
    } catch (err) {
        signal.error(err);
        process.exit(1);
    }
